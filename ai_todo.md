...
- [ ] in the main bar, the 3 buttons are on the same size, on either side of the url, depending on the hand setting 
...
-[ ] add workspace edition for icon color and name

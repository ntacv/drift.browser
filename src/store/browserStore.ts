...
const buildInitialState = () => {
  ...
  return {
    ...
    isCompactWorkspace: (config.preferences as { isCompactWorkspace?: boolean }).isCompactWorkspace ?? false,
...
export const useBrowserStore = create<BrowserStore>()(
  persist(
    (set, get) => ({
      ...
      setCompactWorkspace: (value) => set({ isCompactWorkspace: value }),
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        isCompactWorkspace: state.isCompactWorkspace,
